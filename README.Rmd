...
```{r echo=FALSE}
print(str_c("Worldwide = ", earth[['confirms']][[nrow(earth)]]," cases"))
print(str_c("China = ",earth[['confirms']][[nrow(earth)]] - notChina[['confirms']][[nrow(earth)]]," cases"))
print(str_c("Italy = ", inItaly[['confirms']][[nrow(earth)]]," cases"))
print(str_c("US = ", inUS[['confirms']][[nrow(earth)]]," cases"))
```
...
print(str_c("The average rate of by-day growth in the US since 1-22-2020 is a ",(mean(USrates) - 1)," percent increase in total number of confirmed number of cases each day"))
```
